...
public class ReadCSVServiceImpl extends AbstractMB implements ReadCSVService {
	...
	/* (non-Javadoc)
	 * @see com.gem.sistema.load.fileupload.ReadCSVService#processCsvFile(java.io.InputStream, java.lang.StringBuilder)
	 */
	...
	private String formatError(int ren, int e1, int e2, int e3, int e4, int e5) {
		...
		if (e1 == 1 || e2 == 1 || e3 == 1 || e4 == 1 || e5 == 1) {
			return String.format(pattern2, ren, e1, e2, e3, e4, e5, "NO OK");
		} else
	...
	/* (non-Javadoc)
	 * @see com.gem.sistema.load.fileupload.ReadCSVService#validaPrograma(com.gem.sistema.business.domain.Obra)
	 */
	...
	/* (non-Javadoc)
	 * @see com.gem.sistema.load.fileupload.ReadCSVService#validaPresupuesto(com.gem.sistema.business.domain.Obra)
	 */
...
//			if (paso != null && validaPasoMayorCero(paso) && validaPasoVsObra(paso, obra)) {
			if (paso != null && validaPasoVsObra(paso, obra)) {
				returnValue = 0;
			}
	...
	/* (non-Javadoc)
	 * @see com.gem.sistema.load.fileupload.ReadCSVService#validaPresupuestoManual(com.gem.sistema.business.domain.Obra)
	 */
	public String validaPresupuestoManual(Obra obra) {
		...
		if (!programas.isEmpty()) {
			...
			} /*else if (!validaPasoMayorCero(paso)) {
				returnValue = "Los valores deben ser mayores a cero";
			}*/
		} else {
