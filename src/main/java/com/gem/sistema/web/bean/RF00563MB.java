...
public class RF00563MB extends BaseDirectReport {
	...
	public Map<String, Object> getParametersReports() throws ReportValidationException {
		...
		parametrs.put("anio", firmas.getCampo3());
		parametrs.put("municipio", firmas.getCampo1());
		parametrs.put("pathImg", this.getUserDetails().getPathImgCab1());
		parametrs.put("lblPresidente", firmas.getL27());
		parametrs.put("lblSecretario", firmas.getL5());
		parametrs.put("lblTesorero", firmas.getL3());
		parametrs.put("txtPresidente", firmas.getN27());
		parametrs.put("txtSecretario", firmas.getN5());
		parametrs.put("txtTesorero", firmas.getN3());
