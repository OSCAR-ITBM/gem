...
public class Reporte155MB extends BaseDirectReport {
	...
	public Map<String, Object> getParametersReports() throws ReportValidationException {
		...
		paraameters.put("pAnio", firmas.getCampo3());
		...
		paraameters.put("pL3", firmas.getL13());
		paraameters.put("pL4", firmas.getL4());
		paraameters.put("pL5", firmas.getL24());
		paraameters.put("pN3", firmas.getN13());
		paraameters.put("pN4", firmas.getN4());
		paraameters.put("pN5", firmas.getN24());
		paraameters.put("pNomMuni", firmas.getCampo1());
