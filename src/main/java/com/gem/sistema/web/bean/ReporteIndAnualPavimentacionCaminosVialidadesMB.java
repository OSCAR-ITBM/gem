...
public class ReporteIndAnualPavimentacionCaminosVialidadesMB extends BaseDirectReport {
	...
	public Map<String, Object> getParametersReports() throws ReportValidationException {
		...
		parameters.put("firmaP3",firmas.getL6()); 
		parameters.put("firmaN1",firmas.getN4()); 
		parameters.put("firmaN2",firmas.getN4()); 
		parameters.put("firmaN3",firmas.getN6()); 
		return parameters;
	}
	...
	/**
	 * metodo que busca todas las pm3011 en la base de datos y pone los valores iniciales.
	 */
