...
public class ReporteIndAnualIncrementoRecaudacionMB extends BaseDirectReport {
	...
	public Map<String, Object> getParametersReports() throws ReportValidationException {
		...
		firmas = firmasRepository.findFirstByIdsector(this.getUserDetails().getIdSector());
		conctb = conctbRepository.findByIdsector(this.getUserDetails().getIdSector());
		parameters.put("year", masterList.get(currentPage).getAnual());
		...
		parameters.put("firmaP2", firmas.getL4());
		parameters.put("firmaP3", firmas.getL11());
		parameters.put("firmaN1", firmas.getN4());
		parameters.put("firmaN2", firmas.getN4());
		parameters.put("firmaN3", firmas.getN11());
		return parameters;
	}
