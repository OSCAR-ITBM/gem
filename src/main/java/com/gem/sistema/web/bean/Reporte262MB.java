...
public class Reporte262MB extends BaseDirectReport {
	...
	public Map<String, Object> getParametersReports() throws ReportValidationException {
		...
		parametros.put("entidadName", firmas.getCampo1());
		...
		parametros.put("firmaP4", firmas.getL28());
		parametros.put("firmaN1", firmas.getN27());
		parametros.put("firmaN2", firmas.getN5());
		parametros.put("firmaN3", firmas.getN3());
		parametros.put("firmaN4", firmas.getN28());
