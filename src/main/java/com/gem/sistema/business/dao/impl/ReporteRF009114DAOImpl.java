...
public class ReporteRF009114DAOImpl implements ReporteRF009114DAO {
	 ...
	 *
	 * @param jdbcCallProcedure
	 *            the new jdbc call procedure
	 */
	 ...
	 */
	@Override
	public ReportsParamDTO executeProcedure(ReportsParamDTO reportsParamDTO) {
		ReportsParamDTO reports = new ReportsParamDTO();
		/**
		 * IN i_mes INTEGER, IN i_id_sector INTEGER, IN i_tipo INTEGER, IN
		 * i_query VARCHAR(9000), IN i_qtotal VARCHAR(9000),
		 */
		SqlParameterSource in = new MapSqlParameterSource().addValue("i_idsector", reportsParamDTO.getIdSector())
				.addValue("i_mes", reportsParamDTO.getMes());
		...
		/**
		 * OUT o_cod_error INTEGER, OUT o_msg_error VARCHAR(500), OUT
		 * o_full_file VARCHAR(1000)
		 */
		return reports;
	}
	...
	public ReportsParamDTO executeProcedure(ReportsParamDTO reportsParamDTO, Integer tipo) {
		 ...
		 */
		SqlParameterSource in = new MapSqlParameterSource().addValue("i_idsector", reportsParamDTO.getIdSector())
				.addValue("i_tipo", tipo).addValue("i_mes", reportsParamDTO.getMes());
