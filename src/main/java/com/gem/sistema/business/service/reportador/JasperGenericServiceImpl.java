...
public class JasperGenericServiceImpl implements JasperGenericService {
	...
	/*
	@Autowired
	@Qualifier(value = "tcImagenesEntAdminRepository")
	private TcImagenesEntAdminRepository tcImagenesEntAdminRepository;

	@Autowired
	@Qualifier(value = "tcImagenesMuniRepository")
...
*/
	...
	/* (non-Javadoc)
	 * @see com.gem.sistema.business.service.reportador.JasperGenericService#getReport(java.util.Map, java.lang.String, int)
	 */
	public StreamedContent getReport(Map<String, Object> params, String jasperReportName, int type) {
		...
		case JasperGenericService.CSV:
			return new DefaultStreamedContent(stream, TYPE_CONTENT_CSV, jasperReportName.concat(CSV_EXTENSION), "ISO-8859-1");
		case JasperGenericService.TXT:
			return new DefaultStreamedContent(stream, TYPE_CONTENT_TEXT_PLAIN, jasperReportName.concat(TXT_EXTENSION), "UTF-8");
		default:
			return new DefaultStreamedContent(stream, CONTENT_TYPE_PDF, jasperReportName.concat(PDF_EXTENSION));
		}
	}
	...
	private JasperPrint getJasperReport(Map<String, Object> params, String jasperReportName) {
		...
		try {
			...
			final String jasperPathReport = servletContext.getRealPath(REPORT_PATH_JASPER + FILE_SEPARATOR + jasperReportName +  ".jasper" )  ;
	...
	/* (non-Javadoc)
	 * @see com.gem.sistema.business.service.reportador.JasperGenericService#createReportPdftoFs(java.util.Map, java.lang.String, java.lang.String)
	 */
