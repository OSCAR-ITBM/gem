...
public class ConsultaPolizaSirveImpl implements ConsultaPolizaSirve {
	...
	private static final String WRONG_POLICIES_SQL = "select en.tippol,  en.mespol, en.conpol,  en.ccontrol, en.cdebe  ,  "
			+ "en.chaber, en.ctc600, en.cta600 from polien en where en.stapol = 'I'  and  en.mespol = ? and IDSECTOR = ?   "
			+ "and ((en.cdebe  <> en.chaber or en.ctc600 <> en.cta600) or (en.cdebe = 0 and en.chaber = 0)) order by 1,2,3";
