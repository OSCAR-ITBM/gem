...
public class ReporteRF009114ServiceImpl implements ReporteRF009114Service{
	...
	/* (non-Javadoc)
	 * @see com.gem.sistema.business.service.catalogos.ReporteRF009114Service#executeProcedure(com.gem.sistema.business.dto.ReportsParamDTO)
	 */
	@Override
	public ReportsParamDTO executeProcedure(ReportsParamDTO reportDTO) {
		return this.reporteDAO.executeProcedure(reportDTO);
	}
	@Override
