...
extends PagingAndSortingRepository<Polide, Long>, QueryDslPredicateExecutor<Polide>, PolideRepositoryCustom {
  ...
  Polide findFirstByIdsectorAndConcepAndAnopolOrderByIdAsc(Integer idsector, String concep, Integer anopol);
	...
	Page<Polide> getByYearAndMonth(@Param("anopol") Integer anopol, @Param("mespol") Integer mespol, @Param("idsector") Integer idsector, Pageable pageable);
	...
	Page<Polide> getByMonthAndLevels(@Param("xmes") Integer month,
			@Param("year") Integer year,
			@Param("cta") String cta,
			@Param("scta") String scta,
...
//			+ " and idRef = :idRef "
	...
	List<Polide> getByMesAndCantidad (
	...
	List<Polide> buscarCantidadReferencia(@Param("cantidad") BigDecimal cantidad, @Param("referencia") BigDecimal referencia, @Param("idSector") Integer idSector);
	 ...
	 * @return the polide
	 */
	Polide findByIdsectorAndTippolAndConpolAndRenpolAndMespolAndAnopol(Integer idsector, String tippol, Integer conpol, BigDecimal renpol, Integer mespol, Integer anopol);
	 ...
	 * @return the list
	 */
	List<Polide> findByIdsectorAndTippolAndConpolAndMespolAndAnopol(Integer idsector, String tippol, Integer conpol, Integer mespol, Integer anopol);
