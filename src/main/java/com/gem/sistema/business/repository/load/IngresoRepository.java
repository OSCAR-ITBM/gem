...
public interface IngresoRepository extends PagingAndSortingRepository<Ingreso, Long>, QueryDslPredicateExecutor<Ingreso>{
   ...
   * @return the ingreso
   */
  Ingreso findFirstByCuentaAndSctaAndSsctaAndSssctaAndSsssctaAndIdsector(String cuenta, String scta, String sscta, String ssscta, String sssscta, Long idsector);
