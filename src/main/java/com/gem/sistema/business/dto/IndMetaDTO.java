...
/**
 * The Class IndMetaDTO.
 */
public class IndMetaDTO {
	 ...
	 */
	public void setClvmet(int clvmet) {
		this.clvmet = clvmet;
	}
	...
	public String toString() {
		return "IndMetaDTO [ampli1=" + ampli1 + ", ampli2=" + ampli2 + ", ampli3=" + ampli3 + ", ampli4=" + ampli4
				+ ", ampli5=" + ampli5 + ", anioCap=" + anioCap + ", campo0=" + campo0 + ", campo1=" + campo1
				+ ", campo2=" + campo2 + ", campo3=" + campo3 + ", campo4=" + campo4 + ", campo5=" + campo5
				+ ", canMet=" + canMet + ", canMeta=" + canMeta + ", canMeti=" + canMeti + ", canMetia=" + canMetia
				+ ", canMetic1=" + canMetic1 + ", canMetic10=" + canMetic10 + ", canMetic11=" + canMetic11
				+ ", canMetic12=" + canMetic12 + ", canMetic13=" + canMetic13 + ", canMetic2=" + canMetic2
				+ ", canMetic3=" + canMetic3 + ", canMetic4=" + canMetic4 + ", canMetic5=" + canMetic5 + ", canMetic6="
				+ canMetic6 + ", canMetic7=" + canMetic7 + ", canMetic8=" + canMetic8 + ", canMetic9=" + canMetic9
				+ ", cantAvan1=" + cantAvan1 + ", cantAvan10=" + cantAvan10 + ", cantAvan11=" + cantAvan11
				+ ", cantAvan12=" + cantAvan12 + ", cantAvan13=" + cantAvan13 + ", cantAvan2=" + cantAvan2
				+ ", cantAvan3=" + cantAvan3 + ", cantAvan4=" + cantAvan4 + ", cantAvan5=" + cantAvan5 + ", cantAvan6="
				+ cantAvan6 + ", cantAvan7=" + cantAvan7 + ", cantAvan8=" + cantAvan8 + ", cantAvan9=" + cantAvan9
				+ ", clavedep=" + clavedep + ", clvdep=" + clvdep + ", clvfuen=" + clvfuen + ", clvmet=" + clvmet
				+ ", clvnep=" + clvnep + ", clvreg=" + clvreg + ", costo=" + costo + ", formula=" + formula + ", idRef="
				+ idRef + ", idsector=" + idsector + ", nomInd=" + nomInd + ", nomMet=" + nomMet + ", numVer=" + numVer
				+ ", progante=" + progante + ", redu1=" + redu1 + ", redu2=" + redu2 + ", redu3=" + redu3 + ", redu4="
				+ redu4 + ", redu5=" + redu5 + ", uniMed=" + uniMed + ", userid=" + userid + ", varfin1=" + varfin1
				+ ", varfin2=" + varfin2 + ", varfin3=" + varfin3 + ", varfin4=" + varfin4 + ", varfis1=" + varfis1
				+ ", varfis2=" + varfis2 + ", varfis3=" + varfis3 + ", varfis4=" + varfis4 + ", id=" + id
