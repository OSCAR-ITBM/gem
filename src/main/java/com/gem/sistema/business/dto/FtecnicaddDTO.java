...
public class FtecnicaddDTO implements Serializable {
	...
	public FtecnicaddDTO(long id, String clvdep, String clvfin, String clvfun, int codigo, String cveind,
			String cvetemas, String cvevar, Date feccap, long idRef, int idsector, BigDecimal metanual, String nope,
			String pe, String tema, String tipoper, BigDecimal trim1, BigDecimal trim2, BigDecimal trim3,
