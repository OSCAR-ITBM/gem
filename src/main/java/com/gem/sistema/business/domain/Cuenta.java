...
public class Cuenta extends AbstractEntity {
	...
	private BigDecimal abonos1;

	/** The abonos 10. */
	@Column(name = "ABONOS_10")
	private BigDecimal abonos10;

	/** The abonos 11. */
	@Column(name = "ABONOS_11")
	private BigDecimal abonos11;

	/** The abonos 12. */
	@Column(name = "ABONOS_12")
	private BigDecimal abonos12;

	/** The abonos 13. */
	@Column(name = "ABONOS_13")
	private BigDecimal abonos13;

	/** The abonos 14. */
	@Column(name = "ABONOS_14")
	private BigDecimal abonos14;

	/** The abonos 15. */
	@Column(name = "ABONOS_15")
	private BigDecimal abonos15;

	/** The abonos 16. */
	@Column(name = "ABONOS_16")
	private BigDecimal abonos16;

	/** The abonos 2. */
	@Column(name = "ABONOS_2")
	private BigDecimal abonos2;

	/** The abonos 3. */
	@Column(name = "ABONOS_3")
	private BigDecimal abonos3;

	/** The abonos 4. */
	@Column(name = "ABONOS_4")
	private BigDecimal abonos4;

	/** The abonos 5. */
	@Column(name = "ABONOS_5")
	private BigDecimal abonos5;

	/** The abonos 6. */
	@Column(name = "ABONOS_6")
	private BigDecimal abonos6;

	/** The abonos 7. */
	@Column(name = "ABONOS_7")
	private BigDecimal abonos7;

	/** The abonos 8. */
	@Column(name = "ABONOS_8")
	private BigDecimal abonos8;

	/** The abonos 9. */
	@Column(name = "ABONOS_9")
	private BigDecimal abonos9;
	...
	private BigDecimal cargos1;

	/** The cargos 10. */
	@Column(name = "CARGOS_10")
	private BigDecimal cargos10;

	/** The cargos 11. */
	@Column(name = "CARGOS_11")
	private BigDecimal cargos11;

	/** The cargos 12. */
	@Column(name = "CARGOS_12")
	private BigDecimal cargos12;

	/** The cargos 13. */
	@Column(name = "CARGOS_13")
	private BigDecimal cargos13;

	/** The cargos 14. */
	@Column(name = "CARGOS_14")
	private BigDecimal cargos14;

	/** The cargos 15. */
	@Column(name = "CARGOS_15")
	private BigDecimal cargos15;

	/** The cargos 16. */
	@Column(name = "CARGOS_16")
	private BigDecimal cargos16;

	/** The cargos 2. */
	@Column(name = "CARGOS_2")
	private BigDecimal cargos2;

	/** The cargos 3. */
	@Column(name = "CARGOS_3")
	private BigDecimal cargos3;

	/** The cargos 4. */
	@Column(name = "CARGOS_4")
	private BigDecimal cargos4;

	/** The cargos 5. */
	@Column(name = "CARGOS_5")
	private BigDecimal cargos5;

	/** The cargos 6. */
	@Column(name = "CARGOS_6")
	private BigDecimal cargos6;

	/** The cargos 7. */
	@Column(name = "CARGOS_7")
	private BigDecimal cargos7;

	/** The cargos 8. */
	@Column(name = "CARGOS_8")
	private BigDecimal cargos8;

	/** The cargos 9. */
	@Column(name = "CARGOS_9")
	private BigDecimal cargos9;
	 ...
	 * insertable=false, updatable=false) private Maycta maycta;
	 */
	 ...
	 */
	public Cuenta(String cuenta, String scuenta, String sscuenta, String ssscuenta, String sssscuenta, String nomcta,
			String nivcta, Integer xnicta, String capcta, Long idsector) {
		this.cuenta = cuenta;
		this.scuenta = scuenta;
		this.sscuenta = sscuenta;
		this.ssscuenta = ssscuenta;
